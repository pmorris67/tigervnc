...
if(BUILD_WINVNC)
	set(INST_BASE_NAME ${CMAKE_PROJECT_NAME}-all)
else()
	set(INST_BASE_NAME ${CMAKE_PROJECT_NAME}-viewer)
endif()

if(CMAKE_SIZEOF_VOID_P MATCHES 8)
  set(INST_NAME ${INST_BASE_NAME}64-${VERSION})
  set(INST_DEFS -DWIN64)
else()
  set(INST_NAME ${INST_BASE_NAME}-${VERSION})
endif()
